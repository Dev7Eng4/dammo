...

{
  ...
  "thumbnail": {
    ...
    "prompt": "Professional Japanese YouTube health thumbnail graphic design. On the left, a detailed close-up of a steaming bowl of freshly prepared natto with green onions, overlaid with a bold red warning cross (❌). On the right, a dignified 65-year-old Japanese doctor with neatly combed silver hair and glasses in a white lab coat gesturing with a warning finger. In the top-right corner, a bold red badge '【要注意】'. Running across the center-top, massive 3D Japanese typography reading '「絶対NGな食べ方」' in radiant yellow with thick heavy black outline and deep drop shadow, followed by secondary white text '毎朝の習慣で血管がドロドロに…'. High contrast, bright medical studio lighting, styled in ${imageStyle} --ar 16:9"
  },
}
`;
