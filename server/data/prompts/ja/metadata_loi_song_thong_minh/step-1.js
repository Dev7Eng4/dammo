...
Do NOT write \`\`\`json.
Do NOT add explanations, comments, analysis, or text before or after the JSON.
...
Generate at least 10 internal candidates using genuinely different angles:
...
3. Increase curiosity or viewer relevance without unsupported information.
...
Create "image_generation_prompt" INSIDE the "thumbnail" object.

It must be a COMPLETE, independently usable English image-generation prompt for generating the finished YouTube thumbnail.
...
The exact Japanese thumbnail text MUST appear verbatim inside the prompt.

Explicitly instruct the image model to render those exact Japanese characters.

Do not translate, modify, shorten, or paraphrase the Japanese text.

The prompt must generate the COMPLETE thumbnail, including visual scene AND typography.
...
2. No future or invented content.
3. No unsupported health, scientific, financial, or longevity claims.
4. Personal experience is not presented as universal fact.
5. Title is specific, natural, relevant, and curiosity-driven.
6. Alternative titles use genuinely different angles.
...
13. Exact thumbnail text appears verbatim in thumbnail.image_generation_prompt.
14. thumbnail.image_generation_prompt is complete and independently usable.
15. video_visual_prompt is complete, distinct, and contains no text.
16. No style drift.
17. JSON is syntactically valid.
18. Output contains nothing except the JSON object.
...

{
  ...
  "thumbnail": {
    ...
    "image_generation_prompt": "FINAL COMPLETE ENGLISH THUMBNAIL IMAGE-GENERATION PROMPT"
  },
