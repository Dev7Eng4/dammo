...
Generate a complete Japanese YouTube metadata package, complete thumbnail-generation specification, and one cinematic visual prompt suitable for use throughout the video.
...
STORY INPUT
→ Only source of factual story information.
...
If OLD TITLE conflicts with STORY INPUT, follow STORY INPUT.

If IMAGE STYLE conflicts with an assumed visual style, follow IMAGE STYLE.
...
Only use information confirmed by STORY INPUT.

If meaning is uncertain, do not use it as a factual claim.

==================================================
STORY INPUT
===========

STORY INPUT may contain:

1. a complete story analysis for a short video, or
2. a FINAL STORY DOSSIER reconstructed from multiple transcript segments.

Treat both as the factual story source.

Do not infer information missing from STORY INPUT.

Do not predict unsupported events.

Do not fabricate an ending, twist, revelation, resolution, or outcome.
...
Determine the actual niche from the story.
...
Prioritize legitimate hooks such as:

1. Human relationship tension
2. Emotional revelation
3. Hidden meaning
4. Mystery surrounding a confirmed object, action, or statement
5. Reversal
...
unless genuinely justified by the story.
...
- use specific story-supported information
...
Alternative 1:
Use a meaningfully different emotional or relationship angle.

Alternative 2:
Use a meaningfully different curiosity, mystery, reversal, or specific-detail angle.
...
Sentence 3:
Increase curiosity without fabrication or unnecessarily revealing the resolution.
...
- tags must reflect the actual story
...
Choose the strongest visual hook from the COMPLETE STORY.
...
Do not force a character-centered composition if an object or another visual element is stronger.
...
Prefer approximately 2–8 Japanese words and, whenever possible, roughly 3–7 characters or compact word units.
...
- be supported by the story
- complement the title
- add information or emotion rather than simply repeat the title

The exact selected thumbnail text MUST appear verbatim inside image_generation_prompt.
...
Do not cover important eyes, facial expressions, important objects, or critical story elements.
...
STORY INPUT determines WHAT appears.

IMAGE STYLE determines HOW it appears.

Never append IMAGE STYLE to a generic prompt without adapting the entire visual direction.
...
If IMAGE STYLE contains a detailed style profile:
preserve its defining characteristics.
...
Use only story-supported characters and objects.
...
Represent the CENTRAL STORY rather than a single dramatic moment.
...
The video visual must follow IMAGE STYLE exactly.
...
Do not invent unsupported visual elements.
...
Create a clean cinematic story image suitable for repeated use throughout the video.
...
24. Neither prompt predicts unsupported events.
...

{
  ...
  "thumbnail": {
    ...
    "thumbnail_text": "Exact Japanese text that must appear",
    "text_color": {
    ...
    "image_generation_prompt": "FINAL COMPLETE ENGLISH IMAGE-GENERATION PROMPT"
  },
  "video_visual_prompt": "FINAL COMPLETE ENGLISH IMAGE-GENERATION PROMPT"
}
