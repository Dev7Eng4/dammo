/** CSS selectors for YouTube Studio upload flow (Playwright + GPM). */
export const YOUTUBE_SELECTOR = {
  ...
  boxPlaylist: 'ytcp-video-metadata-playlists',
  playlistFirstItem: '#playlists-list #items ytcp-ve:nth-of-type(1) ytcp-checkbox-lit',
  playlistClose: '.ytcp-playlist-dialog .action-buttons .done-button button',
