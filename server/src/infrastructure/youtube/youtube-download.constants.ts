...
export const YOUTUBE_VIDEO_DOWNLOAD_FORMATS = [
  'bestvideo[height=720][ext=mp4][vcodec^=avc][fps<=30]/bestvideo[width=720][ext=mp4][vcodec^=avc][fps<=30]',
  'bestvideo[height=720][ext=mp4][vcodec^=avc]/bestvideo[width=720][ext=mp4][vcodec^=avc]',
] as const;
